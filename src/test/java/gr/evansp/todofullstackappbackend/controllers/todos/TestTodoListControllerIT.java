...
class TestTodoListControllerIT extends BaseITTest {
  ...
  void testReadAll_ForbiddenGreek() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI).header("Accept-Language", "el-GR"))
  ...
  void testReadAll_ForbiddenEnglish() throws Exception {
    SecurityContextHolder.clearContext();
    mockMvc
        .perform(MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI))
        .andExpect(status().isForbidden())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void testRead_badRequestGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI + "/asd")
  ...
  void testRead_badRequestEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI + "/asd"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
  ...
  void testBadURL_greek() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/asd").header("Accept-Language", "el-GR"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
                .bytes(
                    "{\"message\":\"Δεν βρέθηκε περιεχόμενο στο συγκεκριμένο URL.\",\"messages\":null}"
                        .getBytes()));
  }
  ...
  void testBadURL_english() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/asd"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
                .bytes(
                    "{\"message\":\"No content found at the specified URL.\",\"messages\":null}"
                        .getBytes()));
  }
  ...
  void testFind_notFoundEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI + "/-1"))
  ...
  void testFind_notFoundGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI + "/-1")
                .header("Accept-Language", "el-GR"))
        .andExpect(status().isNotFound())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content().bytes("{\"message\":\"Η λίστα δεν βρέθηκε.\",\"messages\":null}".getBytes()));
  }
  ...
  void testFind_unauthorizedGreek() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(TODO_LISTS_BASE_URI + "/" + list.getTodoListId().toString())
                .header("Accept-Language", "el-GR"))
        .andExpect(status().isForbidden())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void testCreate_noRequestBodyEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.post(TODO_LISTS_BASE_URI))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
  ...
  void testCreate_noRequestBodyGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(TODO_LISTS_BASE_URI).header("Accept-Language", "el-GR"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
  ...
  void testCreate_mediaTypeNotSupportedGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(TODO_LISTS_BASE_URI)
                .header("Accept-Language", "el-GR")
                .content("{}"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  void testCreate_mediaTypeNotSupportedEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.post(TODO_LISTS_BASE_URI).content("{}"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
  ...
  void testCreate_EmptyUserIdEnglish() throws Exception {
    mockMvc
        ...
        .andExpect(
            content()
                .bytes(
                    "{\"message\":null,\"messages\":{\"userId\":\"User ID should not be empty.\"}}"
                        .getBytes()))
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void testCreate_EmptyUserIdGreek() throws Exception {
    mockMvc
        ...
        .andExpect(
            content()
                .bytes(
                    "{\"message\":null,\"messages\":{\"userId\":\"Το ID του χρήστη δεν μπορεί να είναι κενό.\"}}"
                        .getBytes()))
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void testCreate_ok() throws Exception {
    String content = "{\"title\": \"lalala\", \"userId\":" + "\"" + SUB + "\"" + "}";
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(TODO_LISTS_BASE_URI)
                .content(content)
  ...
  void testDelete_noListId() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete(TODO_LISTS_BASE_URI)
                .contentType(MediaType.APPLICATION_JSON))
  ...
  void testDelete_badRequestUrl() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete(TODO_LISTS_BASE_URI + "/asdsad")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
                .bytes(
  ...
  void testDelete_notFoundEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.delete(TODO_LISTS_BASE_URI + "/1"))
        .andExpect(status().isNotFound())
        .andExpect(
            content().bytes("{\"message\":\"List was not found.\",\"messages\":null}".getBytes()));
  }
  ...
  void testDelete_notFoundGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete(TODO_LISTS_BASE_URI + "/1")
                .header("Accept-Language", "el-GR"))
        .andExpect(status().isNotFound())
        .andExpect(
            content().bytes("{\"message\":\"Η λίστα δεν βρέθηκε.\",\"messages\":null}".getBytes()));
  ...
  void testDelete_forbidden() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete(TODO_LISTS_BASE_URI + list.getTodoListId())
                .header("Accept-Language", "el-GR"))
        .andExpect(
            content().bytes("{\"message\":\"Δεν έχετε πρόσβαση.\",\"messages\":null}".getBytes()))
        .andExpect(status().isForbidden());
  ...
  void testUpdate_noRequestBodyEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.put(TODO_LISTS_BASE_URI))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content().bytes("{\"message\":\"Faulty Request Body.\",\"messages\":null}".getBytes()));
  ...
  void testUpdate_noRequestBodyGreek() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.put(TODO_LISTS_BASE_URI).header("Accept-Language", "el-GR"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
  ...
  void testUpdate_mediaTypeNotSupportedGreek() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(TODO_LISTS_BASE_URI)
                .header("Accept-Language", "el-GR")
                .content("{}"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  void testUpdate_mediaTypeNotSupportedEnglish() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.put(TODO_LISTS_BASE_URI).content("{}"))
        .andExpect(status().isBadRequest())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(
            content()
  ...
  void testUpdate_doesNotExistGreek() throws Exception {
    mockMvc
        ...
        .andExpect(status().isBadRequest())
        .andExpect(
            content().bytes("{\"message\":\"lalala δεν υπάρχει.\",\"messages\":null}".getBytes()));
  }
  ...
  void testUpdate_doesNotExistEnglish() throws Exception {
    mockMvc
        ...
        .andExpect(
            content()
                .bytes("{\"message\":\"lalala does not exist.\",\"messages\":null}".getBytes()));
  }
  ...
  void testUpdate_forbidden1() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(TODO_LISTS_BASE_URI)
                .content(
                    "{\"title\": \"lalala\", \"userId\": \"1\", \"todoListId\": "
                        + list.getTodoListId()
                        + "}")
                .contentType(MediaType.APPLICATION_JSON))
